...
object OpenSimplex2 {
    ...
    private const val SKEW_4D = -0.1381966f
    private const val UNSKEW_4D = 0.309017f
    ...
    fun noise4_ImproveXYZ_ImproveXY(seed: Long, x: Double, y: Double, z: Double, w: Double): Float {
        ...
        val zz = z * 0.2886751345948129
        val ww = w * 0.2236067977499788
        val xr = x + (zz + ww + s2)
        val yr = y + (zz + ww + s2)
        val zr = xy * -0.577350269189626 + (zz + ww)
    ...
    fun noise4_ImproveXYZ_ImproveXZ(seed: Long, x: Double, y: Double, z: Double, w: Double): Float {
        ...
        val yy = y * 0.2886751345948129
        val ww = w * 0.2236067977499788
        val xr = x + (yy + ww + s2)
        val zr = z + (yy + ww + s2)
        val yr = xz * -0.577350269189626 + (yy + ww)
    ...
    fun noise4_ImproveXY_ImproveZW(seed: Long, x: Double, y: Double, z: Double, w: Double): Float {
        val s2 = (x + y) * -0.17827565795139938 + (z + w) * 0.21562339328884284
        val t2 = (z + w) * -0.4039497625802071 + (x + y) * -0.3751990830100753
        val xs = x + s2
        val ys = y + s2
        val zs = z + t2
        val ws = w + t2
    ...
    init {
        val grad2 = floatArrayOf(
            ...
            -0.9238795f, 0.38268343f,
            -0.38268343f, 0.9238795f,
            0.13052619f, 0.9914449f,
            0.6087614f, 0.7933533f,
            0.7933533f, 0.6087614f,
            0.9914449f, 0.13052619f,
            0.9914449f, -0.13052619f,
            0.7933533f, -0.6087614f,
            0.6087614f, -0.7933533f,
            0.13052619f, -0.9914449f,
